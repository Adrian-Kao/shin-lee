    ...
    <div className="space-y-2">
      ...
      {lines.map((l, i) => (
        <div key={i} className="group flex items-start gap-2">
          ...
          {editingIdx === i ? (
            ...
            <>
              <div
                className={`flex-1 ${l.source === 'attorney' ? 'attorney-line' : 'ai-line'} ${l.accepted ? 'opacity-100' : 'opacity-90'} px-1 leading-7`}
              >
      ...
      <div className="mt-4 flex items-center justify-between border-t pt-3">
        ...
        <button
          ...
          onClick={sign}
          className="rounded bg-emerald-600 px-4 py-2 text-sm font-medium text-white disabled:bg-slate-300"
        >
          {signed ? '已簽核' : '律師簽核'}
        </button>
      </div>
