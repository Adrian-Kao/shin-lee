  ...
  'zh-TW': {
    common: {
      ...
      signoff: {
        ...
        excluded: '已排除',
        undo: '撤銷',
        accept_all_rest: '接受剩餘 {{count}} 句',
        accepted_count: '{{count}} 接受',
        excluded_count: '{{count}} 排除',
        view_original: '檢視 AI 原文',
        hide_original: '收合原文',
        kbd_hint: '快捷鍵：A 接受 · E 改寫 · X 排除 · U 撤銷',
        edit_kbd_hint: 'Ctrl+Enter 儲存 · Esc 取消',
        undecided_hint: '尚有 {{count}} 句未決定（接受或排除）— 全部決定後才能匯出。',
        add_line: '新增句子',
  ...
  en: {
    common: {
      ...
      signoff: {
        ...
        excluded: 'Excluded',
        undo: 'Undo',
        accept_all_rest: 'Accept remaining {{count}}',
        accepted_count: '{{count}} accepted',
        excluded_count: '{{count}} excluded',
        view_original: 'View AI original',
        hide_original: 'Hide original',
        kbd_hint: 'Shortcuts: A accept · E edit · X exclude · U undo',
        edit_kbd_hint: 'Ctrl+Enter save · Esc cancel',
        undecided_hint:
          '{{count}} sentence(s) still undecided (accept or exclude) — export unlocks once every line is decided.',
